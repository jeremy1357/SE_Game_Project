...
void GameScreen::on_render()
{
	...
	m_spriteRenderer.add_static_sprite_to_batch(glm::vec2(-2, 2), m_levelManager.get_texture_ID('#'));
	m_spriteRenderer.add_static_sprite_to_batch(glm::vec2(0, -2), m_levelManager.get_texture_ID('#'));

	m_spriteRenderer.add_static_sprite_to_batch(glm::vec2(1, -2), m_levelManager.get_texture_ID('-'));
